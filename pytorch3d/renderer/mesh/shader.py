...
from ..lighting import PointLights, PointLights_v06
...
from .shading import (
    ...
    gouraud_shading,
    phong_shading,
    multi_blinnphong_shading, 
    multi_blinnphong_baking, 
    multi_blinnphong_baking_tensor,
)
...
class MultiTexturedSoftPhongShader(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.lights = lights if lights is not None else PointLights_v06(device=device)
        self.materials = (
    ...
    def forward(self, fragments: Fragments, meshes: Meshes, **kwargs) -> torch.Tensor:
        ...
        texels = meshes.sample_textures_v06(fragments, multi=True)
